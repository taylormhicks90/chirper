<template>
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1000" height="151" viewBox="0 0 1000 151">
    <g transform="matrix(1,0,0,1,-0.6060606060606233,0.3269977443249985)">
      <svg viewBox="0 0 396 60" data-background-color="#ffffff" preserveAspectRatio="xMidYMid meet" height="151"
           width="1000" xmlns="http://www.w3.org/2000/svg">
        <defs></defs>
        <g id="tight-bounds" transform="matrix(1,0,0,1,0.2400000000000091,-0.12993287853973357)">
          <svg viewBox="0 0 395.52 60.25986575707949" height="60.25986575707949" width="395.52">
            <g>
              <svg viewBox="0 0 525.4770212270112 80.05960446392017" height="60.25986575707949" width="395.52">
                <g>
                  <rect width="6.60461505772513" height="80.05960446392017" x="106.06283795534581" y="0" fill="#7a26c1"
                        opacity="1" stroke-width="0" stroke="transparent" fill-opacity="1" class="rect-o-0"
                        data-fill-palette-color="primary" rx="1%" id="o-0" data-palette-color="#7a26c1"></rect>
                </g>
                <g transform="matrix(1,0,0,1,129.95702122701107,0.19915324493511832)">
                  <svg viewBox="0 0 395.52000000000004 79.66129797404993" height="79.66129797404993"
          ...
          <rect width="395.52" height="60.25986575707949" fill="none" stroke="none" visibility="hidden"></rect>
        </g>
      </svg>
    </g>
  </svg>
